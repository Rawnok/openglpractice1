...
Texture::Texture(const std::string& filePath)
	...
	stbi_set_flip_vertically_on_load(1); // to make sure 0.0 is left bot, 1.1 top right
	m_LocalBuffer = stbi_load(filePath.c_str(), &m_Width, &m_Height, &m_BitsPerPixel, 4); // 4=channel count, r g b a
